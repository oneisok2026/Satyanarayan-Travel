 ...
 *
 * Appear after a short scroll so they do not cover hero content on first
 * paint. On mobile they sit above the safe-area inset so they clear the
 * iOS home indicator.
 */
  ...
  return (
    ...
    >
      <a
        ...
        className={cn(
          'group grid size-13 place-items-center rounded-full bg-[#25D366] text-white',
          'shadow-[--shadow-float] transition-transform duration-200',
          'hover:scale-105 active:scale-95 motion-reduce:transform-none',
        )}
      >
        <svg className="size-6.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <a
        ...
        className={cn(
          'grid size-13 place-items-center rounded-full bg-accent-600 text-white',
          'shadow-[--shadow-float] transition-transform duration-200',
          'hover:scale-105 active:scale-95 motion-reduce:transform-none',
        )}
      >
